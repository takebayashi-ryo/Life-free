...
> ⚠️ **いま主戦場はこのリポジトリではありません。**
> 逆算思考でやり直した結果、次に作るのは別アプリ **「そだつ － 月齢がはいるカメラ」** です。
> 仕様・市場調査・MVPは [`docs/sodatsu.md`](docs/sodatsu.md) に一式あります。**まずこれを読むこと。**
> （検証を通過したら専用リポジトリへ移します）
>
...
> - なお「このさき」（働き方比較アプリ）は**棚上げ**。理由は `docs/sodatsu.md` 付録。
